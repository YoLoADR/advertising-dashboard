			...
			<v-layout row wrap>
					...
					<v-card flat>
						<v-card-text>
							<v-layout row wrap>
								...
								<v-flex xs12 sm6>
									<v-select  hide-details v-bind:items="items"  v-model="e1"  label="Select"  single-line  bottom ></v-select>
								</v-flex>
								<v-flex xs12 sm6>
				...
				>
					...
					<v-layout row wrap>
						...
						<v-flex xs12 sm6>
							<v-select  hide-details v-bind:items="states"  v-model="e1"  label="Select"  single-line auto prepend-icon="map"  hide-details></v-select>
						</v-flex>
						<v-flex xs12 sm6>
							<span class="small pt-4 d-block">Appended icon</span>
						</v-flex>
						<v-flex xs12 sm6>
							<v-select  hide-details v-bind:items="states"  v-model="e5"  label="Select"  single-line  auto  append-icon="map"  hide-details></v-select>
						</v-flex>
					</v-layout>
				</app-card>
			</v-layout>
